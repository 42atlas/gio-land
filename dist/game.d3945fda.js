  ...
  "node_modules/parcel-bundler/src/builtins/bundle-url.js" : [
    function(require, module, exports) {
      ...
      function getBundleURL() {
        // Attempt to find the URL of the current script and use that as the
        // base URL
        try {
          throw new Error();
        } catch (err) {
        ...
        ws.onmessage = function(event) {
          ...
          if (data.type === 'update') {
            ...
            if (handled) {
              ...
              assetsToAccept.forEach(function(v) { hmrAcceptRun(v[0], v[1]); });
            } else if (location.reload) {
              // `location` global exists in a web worker context but lacks
              // `.reload()` function.
              location.reload();
            }
          }
