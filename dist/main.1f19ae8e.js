                ...
                function(require, module, exports) {
                      ...
                      LEVELS =
                          [
                            ...
                            [
                              "                                                                                                                                                                                                            ",
                              "                                                                                                                                                                                                            ", "                                                                                                                                                                                                            ", "                                                                                                                                                                                                            ",
                              "                                               ????????????b???????u???????????????                                                                                                                         ", "                                   -?-                                                                                                                                                                      ", "                                                                                                                  -?-                                                                                       ", "      -?-b-                  -?-                                                         -f-          --                                    --?-                                                            ", "                                                                                                                                u                                               fbf?-b                      ", "                                                                                                                                                                                                            ", "                                                                                                                      _                                                                                     ", "                                                                      Y          Y                       _            |                                      _                                              ", "       _               _                  _                           _          _                       |            |                  _                   |                                              ", "       |               |          E       |    E       A         A    |     D    |                       |            |         D        |        D          |     _  D             D          A  H         ",
                              "================     ================================================================  ==========    =========   ==============================================  ===========================================",
                              "================     ================================================================  ==========    =========   ==============================================  ==========================================="
                            ]
                          ];
                  var levelConf = {
                    ...
                    "!" : function _() {
                      return [
                        ...
                        origin("bot"), "emptyBox", "wall"
                      ];
                    },
                    c : function c() {
                      return [
                        sprite("coin"), area(), solid(), bump(64, 8), cleanup(),
                        lifespan(1, {fade : 0.5}), origin("bot"), "coin"
                      ];
                    },
                    M : function M() {
                      return [
                        sprite("bigMushy"), area(), solid(), patrol(10000),
                    ...
                    _ : function _() {
                      return [
                        sprite("pipeTop"), area(), solid(), origin("bot"),
                        "pipe", "wall"
                      ];
                    },
                    E : function E() {
                      return [
                        ...
                        area({width : 20, height : 24}), solid(), body(),
                        patrol(50), tarma(), origin("bot"), "badGuy", "enemy"
                      ];
                    },
                    A : function A() {
                      return [
                        sprite("enemies", {anim : "Walk"}),
                        area({width : 26, height : 20}), solid(), body(),
                        patrol(100), ami(), origin("bot"), "badGuy", "enemy"
                      ];
                    },
                    D : function D() {
                      return [
                        sprite("enemies", {anim : "WalkHB"}),
                        area({width : 20, height : 28}), solid(), body(),
                        patrol(50), dito(),
                    ...
                    p : function p() {
                      return [
                        ...
                        area({width : 16, height : 16}), body(), mario(),
                        bump(150, 20, false), origin("bot"), "player",
                        {score : 0}
                      ];
                    }
                  }; // scene START
                  ...
                  scene("lose", function(score, time) {
                    add([
                      ...
                      pos(width() / 2, height() / 2 - 80), scale(2),
                      origin("center")
                    ]); // display score

                    add([
                      text("Score:".concat(score), {size : 8, font : "sink"}),
                      pos(width() / 2, height() / 2 - 30), scale(2),
                      origin("center"), setData("score", score)
                    ]); // display time

                    add([
                      text("Time:".concat(time.toFixed(2)),
                           {size : 8, font : "sink"}),
                      pos(width() / 2, height() / 2 - 0), scale(2),
                      origin("center"), setData("time", time.toFixed(2))
                    ]);
                    add([
                    ...
                    onKeyRelease(
                        "enter",
                        function() { return go("game"); }); // highscore

                    /*
                    add([
                      text(`Insert name to record highscore:`, { size: 5, font:
                    "sink" }), pos(width() / 2, height() / 2 + 20), scale(2),
                      origin("center"),
                    ]);
                      const input = add([
                    ...
                    => { setData("name", input.text); debug.log("Yea, check the
                    highscore under the game!");
                    });
                    addButton("Start Again", vec2(width() / 2, height() / 2 +
                    80), () => go("game")
                    );
                      onCharInput((ch) => {
                      input.text += ch;
                      ...
                      input.text = input.text.substring(0, input.text.length -
                    1);
                    }); */
                  ...
                  scene("win", function(score, time) {
                    add([
                      text("YOU WON!"), pos(width() / 2, height() / 2 - 100),
                  ...
                  scene("game", function() {
                    ...
                    add([
                      sprite("hill"), pos(3000, 208), layer("bg"), origin("bot")
                    ]);
                    add([
                      sprite("hill"), pos(3500, 208), layer("bg"), origin("bot")
                    ]);
                    add([
                      sprite("shrubbery"), pos(200, 208), layer("bg"),
                      origin("bot")
                    ]);
                    add([
                      sprite("shrubbery"), pos(680, 208), layer("bg"),
                      origin("bot")
                    ]);
                    add([
                      sprite("shrubbery"), pos(480, 208), layer("bg"),
                      origin("bot")
                    ]);
                    add([
                    ...
                    add([
                      ...
                      pos(vec2(160, 120)), color(255, 255, 255),
                      origin("center"), layer("ui"), lifespan(1, {fade : 0.5})
                    ]); // timer
                    ...
                    var timer = add([
                      text(time, {size : 8, font : "sink"}), pos(50, 10),
                      fixed(), {time : 0}, origin("center"), layer("ui")
                    ]);
                    ...
                    var scoreText = add([
                      text(score, {size : 8, font : "sink"}), pos(170, 10),
                      origin("center"), layer("ui"), fixed()
                    ]);
                          ...
                          for (var _i = 0; _i < 2; _i++) {
                            add([
                              pos(
                                  ...
                                  p),
                              rect(4, 4), outline(4), scale(1 * size, 1 * size),
                              lifespan(0.1), grow(rand(10, 10) * size),
                              origin("center")
                            ]);
                          }
                        });
                    ...
                    function spawnBullet(p) {
                      ...
                      add([
                        sprite("noce"), area(), pos(p), origin("center"),
                        /* move(RIGHT, BULLET_SPEED), */
                        cleanup(), "bullet", {
                          bulletSpeed : current_direction == directions.LEFT
                                            ? -1 * BULLET_SPEED
                                            : BULLET_SPEED
                        }
                      ]);
                    ...
                    onKeyPress("space", function() {
                      if (player.isFlamy) {
                        ...
                        play("noce",
                             {volume : 0.1, detune : rand(-1200, 1200)});
                      }

                      wait(0.2), function() { return; };
                    });
                    ...
                    +_dito.onStateEnter("attack", async () => {
                      ...
                      // Like .onUpdate() which runs every frame, but only runs
                    when the current state is "move"
                    // Here we move towards the player every frame if the
                    current state is "move" _dito.onStateUpdate("move", () => {
                      if (!player.exists()) return;
                      const dir = player.pos.sub(_dito.pos).unit();
                      _dito.move(dir.scale(DITO_SPEED));
                    });
                      // Have to manually call enterState() to trigger the
                    onStateEnter("move") event we defined above.
                    ...
                    var canSquash = false;
                    player.onFall(function() { canSquash = true; });
                    ...
                    player.on("headbutt", function(obj) {
                      if (obj.is("questionBox")) {
                        if (obj.is("coinBox")) {
                          ...
                          updateScore(5);
                          play("coin",
                               {volume : 0.2, detune : rand(-400, 100)});
                        } else if (obj.is("mushyBox")) {
                          level.spawn("M", obj.gridPos.sub(0, 1));
                          play("goodbox",
                               {volume : 0.7, detune : rand(-400, 100)});
                    ...
                    player.onCollide("castle", function(castle, side) {
                      ...
                      music.pause();
                      play("stageclear",
                           {volume : 0.2, detune : rand(-200, 100)});
                      add([
                  ...
                  function patrol() {
                    ...
                    return {
                      ...
                      add : function add() {
                        ...
                        this.onCollide("badGuy", function() { dir = -dir; });
                        this.onCollide("pipe", function() { dir = -dir; });
                      },
                      update : function update() {
                        if (Math.abs(this.pos.x - this.startingPos.x) >=
                            distance) {
                          dir = -dir;
                        }
                  ...
                  function mario() {
                    return {
                      ...
                      standing : function standing() {
                        ...
                        /* this.frame = this.isBig ? this.bigStopFrame :
                         * this.smallStopFrame; */
                      },
                      jumping : function jumping() {
                        ...
                        /* this.frame = this.isBig ? this.bigJumpFrame :
                         * this.smallJumpFrame; */
                      },
                      ...
                      running : function running() {
                        ...
                        /* const animation = this.isBig ? this.bigAnimation :
                         * this.smallAnimation; */
                      ...
                      freeze : function freeze() { this.isFrozen = true; },
                      die : function die() {
                        /* this.stop();
            ...
            function(require, module, exports) {
              ...
              function Module(moduleName) {
                ...
                this.hot = {
                  ...
                  _disposeCallbacks : [],
                  accept : function(
                      fn) { this._acceptCallbacks.push(fn || function() {}); },
                  dispose : function(fn) { this._disposeCallbacks.push(fn); }
                };
              ...
              if ((!parent || !parent.isParcelRequire) &&
                ...
                ws.onmessage = function(event) {
                  ...
                  if (data.type === 'update') {
                    ...
                    if (handled) {
                      console.clear();
                      data.assets.forEach(function(
                          asset) { hmrApply(global.parcelRequire, asset); });
                      assetsToAccept.forEach(function(
                          v) { hmrAcceptRun(v[0], v[1]); });
                    } else if (location.reload) {
                      // `location` global exists in a web worker context but
                      // lacks `.reload()` function.
                      location.reload();
                    }
                  }
              ...
              function hmrAcceptRun(bundle, id) {
                ...
                if (cached && cached.hot &&
                  ...
                  cached.hot._disposeCallbacks.forEach(function(
                      cb) { cb(bundle.hotData); });
                }
                ...
                if (cached && cached.hot &&
                    cached.hot._acceptCallbacks.length) {
                  cached.hot._acceptCallbacks.forEach(function(cb) { cb(); });
