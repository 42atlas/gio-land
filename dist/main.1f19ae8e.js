    ...
    "main.js": [
      function (require, module, exports) {
        ...
        scene("lose", function (score, time) {
          ...
          add([
            text("Time:".concat(time.toFixed(2)), { size: 8, font: "sink" }),
          ...
          player.onCollide("badGuy", function (baddy) {
            ...
            if (canSquash) {
              ...
              if (player.isFlamy) {
                ...
                wait(0.25, function () {
                  player.bigger();
                  play("getsmall", { volume: 0.2, detune: rand(-100, 0) });
                });
          ...
          player.on("headbutt", function (obj) {
            if (obj.is("questionBox")) {
              if (obj.is("coinBox")) {
                ...
                play("goodbox", { volume: 0.7, detune: rand(-400, 100) });
